...
set CommonCompilerFlags=-Gm- -Oi -WX -W4 -EHsc -wd4100 -wd4189 -wd4201 -wd4505 -wd4456 -wd4996 -nologo -Zi -FAsc
...
cl %CommonCompilerFlags% ..\code\tetris.cpp /link %CommonLinkerFlags%
...
REM EHsc: Enable unwind semantics (turn on exception handling)
